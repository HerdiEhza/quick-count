    ...
    <div class="flex flex-col space-y-2">
        ...
        <form>
            <div class="grid gap-6 mb-6 md:grid-cols-6">
                ...
                <div class="col-span-1 md:col-span-2">
                    <label for="suara_tidak_sah"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Suara tidak sah</label>
                        ...
                        <label for="photoC1"
                            ...
                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                ...
                                <p class="mb-2 text-sm text-gray-500 dark:text-gray-400"><span
                                        class="font-semibold">Tekan untuk mengupload</span> foto C1</p>
                    ...
                    <div class="flex items-center justify-center w-full">
                        <label for="photoBAHPS"
                            ...
                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                ...
                                <p class="mb-2 text-sm text-gray-500 dark:text-gray-400"><span
                                        class="font-semibold">Tekan untuk mengupload</span> foto BAHPS</p>
                                <p class="text-xs text-gray-500 dark:text-gray-400">PNG, JPG (MAX.800x400px)</p>
                            </div>
                            @endif
                            <input wire:model="photoBAHPS" name="photoBAHPS" id="photoBAHPS" accept="image/*"
