                    ...
                    <div class="flex flex-row flex-wrap items-center">
                        <div class="flex-shrink w-full max-w-full">
                            ...
                            <h3 class="mb-1 text-lg font-bold">
                                ...
                                <span>{{ number_format($dapils->total_dpt) }}</span>
                            </h3>
                            <p class="text-sm text-green-500">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                    class="inline-block w-4 h-4 bi bi-arrow-up-short" viewBox="0 0 16 16">
                    ...
                    <div class="flex flex-row flex-wrap items-center">
                        <div class="flex-shrink w-full max-w-full">
                            ...
                            <h3 class="mb-1 text-lg font-bold">
                                ...
                                {{-- <span>{{ number_format($dukungans) }}</span> --}}
                                <span>{{ $totalDukungans }}</span>
                            </h3>
                            <p class="text-sm text-green-500">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                    class="inline-block w-4 h-4 bi bi-arrow-up-short" viewBox="0 0 16 16">
                ...
                <div class="h-full p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
                    <div class="flex flex-row flex-wrap items-center">
                        <div class="flex-shrink w-1/2 max-w-full">
                            ...
                            <p class="text-sm text-green-500">
                                *Rp 20,000 / dukungan yang didapat
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="h-full p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
                    <div class="flex flex-row flex-wrap items-center">
                        <div class="flex-shrink w-1/2 max-w-full">
                            ...
                            <p class="text-sm text-green-500">
                                *Rp 30,000 / dukungan yang didapat
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 gap-4 p-4 lg:grid-cols-2">
                ...
                <div class="px-0 mb-0 border-0 rounded-t">
                    <div class="flex flex-wrap items-center px-4 py-2">
                        <div class="relative flex-1 flex-grow w-full max-w-full">
                            <h3 class="text-base font-semibold text-gray-900 dark:text-gray-50">TIMSES RING 1</h3>
                        </div>
            ...
            <div
                ...
                <div class="px-0 mb-0 border-0 rounded-t">
                    <div class="flex flex-wrap items-center px-4 py-2">
                        <div class="relative flex-1 flex-grow w-full max-w-full">
                            <h3 class="text-base font-semibold text-gray-900 dark:text-gray-50">TIMSES RING 2</h3>
                        </div>
                        <div class="relative flex-1 flex-grow w-full max-w-full text-right">
                            <button
                                class="px-3 py-1 mb-1 mr-1 text-xs font-bold text-white uppercase transition-all duration-150 ease-linear bg-blue-500 rounded outline-none dark:bg-gray-100 active:bg-blue-600 dark:text-gray-800 dark:active:text-gray-700 focus:outline-none"
