                ...
                <tbody>
                    <template x-for="(field, index) in fields" :key="index">
                        <tr>
                            ...
                            <td>
                                <input x-model="field.txt1" type="text" name="txt1[]" class="block w-full px-2 py-1 mb-1 text-base leading-normal text-gray-800 bg-white border border-gray-200 rounded appearance-none">
                            </td>
                            <td>
                                <input x-model="field.txt2" type="text" name="txt2[]" class="block w-full px-2 py-1 mb-1 text-base leading-normal text-gray-800 bg-white border border-gray-200 rounded appearance-none">
                            </td>
                            <td>
